...
public class Tables {
	...
	public static List<String> buscaDatosTabla( String tabla, String query, List<String> campos ){
		List<String> datos = new ArrayList<String>();
		 ...
		 try {
	         ...
	         while ( rs.next() ) {
	        	 datos.addAll( Utils.obtieneDatos(campos, rs) );	        	 
	          }
	         stmt.close();
	         con.close();
	      } catch ( Exception e ) {
	...
	public static List<String> verificaTiposTabla( String tabla ){
		List<String> tipos = new ArrayList<String>();
		 ...
		 try {
	         ...
	         stmt = con.createStatement();
	         ResultSet rs = stmt.executeQuery(String.format("SELECT data_type FROM information_schema.columns WHERE table_name = '%s';",
	        		 tabla.trim() ));	         
	         while ( rs.next() ) {
